...
$fetch=$conn->prepare("SELECT * FROM blog WHERE category=2");
$fetch->execute();
  ...
  <body>
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      <ul class="navbar-nav px-4 ms-auto mb-3 mb-lg-2">
        ...
        <li class="nav-item px-4">
          <a class="nav-link active" aria-current="page" href="stories.php"><i class="bi bi-ladder px-2 text-success"></i>Stories</a>
        </li>
        <li class="nav-item px-4">
            ...
            <div class="col-md-6">
              ...
              <div class="card bg-light text-dark">
                <div class="card-body mb-3">
                  <div class="h1">
										<h3><a href="view_blog.php?id=<?=$value['blog_id']?>" class="text-decoration-none text-secondary"><?=$value['title']?></a></h3>
                  </div class="card-title mb-3">
                  <h6><i class="bi bi-person-square"></i>&nbsp;&nbsp;<?=$value['author']?></h6>
                  <hr>
                  <p class="card-text mb-3 d-none"><?= $value['body']?></p>
                </div>
              </div>
						<?php endforeach; ?>
					</div>
            <div class="col-md-3">
							<div class="text-center p-3 mb-3 bg-danger text-light">

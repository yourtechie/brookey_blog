<footer class="p-5 text-light position-relative" style="background-color: #594d5b">
  <div class="container">
    <div class="row d-flex g-3">
      ...
      <div class="col-md-4 pe-3">
        ...
        <p><i class="bi bi-geo-alt pe-2 text-dark"></i>1, Ajayi Close, Alasia</p>
        <p class="ms-4"> Ojo, Lagos State </p>
        <p class="ms-4"> Nigeria</p>
      </div>
      <div class="col-md-4">
        <h4 class="mb-3 fw-bold">Links</h4>
        <p><a href="/" class="text-decoration-none text-light">Home</a></p>
        <p><a href="articles" class="text-decoration-none text-light">Articles</a></p>
        <p><a href="stories" class="text-decoration-none text-light">Stories</a></p>
        <p><a href="poems" class="text-decoration-none text-light">Poems</a></p>
      </div>
    </div>

    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      <ul class="navbar-nav px-4 ms-auto mb-3 mb-lg-2">
        <li class="nav-item px-4">
          <a class="nav-link active" aria-current="page" href="admin"><i class="bi bi-house-door-fill px-2"></i>Home</a>
        </li>
        <li class="nav-item px-4">
          ...
          <div class="row g-3">
            ...
            <div class="col-md-3">
              ...
              <div class="p-3 mb-3 card bg-light text-dark">
                  ...
                  <?php foreach(array_slice($blogs, 0, 3) as $value): ?>
                    <div class="card-body d-flex bd-highlight h4 mb-3">
                      <h5 class="p-2 bd-highlight"><a href="view_blog?id=<?=$value['blog_id']?>" class="text-decoration-none text-secondary"><?=$value['title']?></a></h5>
                    </div>
    						<?php endforeach; ?>
							</div>
          </div>

  ...
  <body>
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      <ul class="navbar-nav px-4 ms-auto mb-3 mb-lg-2">
        ...
        <li class="nav-item px-4">
          <a class="nav-link active" aria-current="page" href="manage_blog"><i class="bi bi-book px-2 text-info"></i>Manage Blog</a>
        </li>
                ...
                <div class="card-body">
                  ...
                  <?php foreach($records as $value): ?>
                    <tr>
                      ...
                      <td><?=$value['body']?></td>
											<td><?=$value['img']?></td>
                      <td><a href="edit_blog?id=<?=$value['blog_id']?>">Edit</a></td>
                      <td><a href="delete_blog?id=<?=$value['blog_id']?>">Delete</a></td>

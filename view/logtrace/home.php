          ...
          <?php if(isset($_GET['message'])){ ?>
              ...
              if(isset($_SESSION['user_id'])){
                ...
                <div class="card bg-light text-dark">
                  <div class="mb-2 d-flex text-light" style="background-color: #953553">
                  ...
                  <div class="card-body">
                    <h5><a href="profile?<?=$_SESSION['user_name']?>&id=<?=$_SESSION['user_id']?>" class="text-decoration-none text_start"><i class="bi bi-person-lines-fill"></i>&nbsp;&nbsp; Profile</a></h5>
                  </div>
                </div>
              <?php } else{ ?>
              <div class="card bg-light text-dark">
